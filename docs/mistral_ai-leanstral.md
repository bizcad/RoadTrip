...
![Leanstrall Normalized Model Cost Vs Flt Eval Score](mistral_ai-leanstral-images/78aaa774-c717-4c60-b71b-1161487b28e5_jpg)
...
- Zero-Setup in [Mistral Vibe](https://mistral.ai/products/vibe): We’ve integrated Leanstral directly into Mistral Vibe for immediate, zero-setup vibe coding and proving. Use `/leanstall` to start.
...
## Share this article
[https://www.linkedin.com/sharing/share-offsite/?url=](https://www.linkedin.com/sharing/share-offsite/?url=)[https://www.facebook.com/sharer/sharer.php?u=](https://www.facebook.com/sharer/sharer.php?u=)[https://twitter.com/intent/tweet?url=](https://twitter.com/intent/tweet?url=)

## More from Mistral AI
- [News](https://mistral.ai/en/news)
- [Models](https://mistral.ai/en/models)
- [AI Services](https://mistral.ai/en/services)

## The next chapter of AI is yours.
[Try le Chat](https://chat.mistral.ai/)[Build on AI Studio](https://console.mistral.ai/)[Talk to an expert](https://mistral.ai/contact)
