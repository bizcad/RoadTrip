...
# Cooking with DiSE (Part 4): Building Systems That Learn, Adapt, and Evolve (English)

Source: https://www.mostlylucid.net/blog/dise-architecture-overview
Notification message
 ...
 - [![mostlylucid limited](mostlylucid_net-dise-architecture-overview-images/logo_svg) ![mostlylucid limited](mostlylucid_net-dise-architecture-overview-images/smalllogo_svg)](https://www.mostlylucid.net/)


 - 0" id="searchresults" class="absolute z-100 my-2 left-0 right-0 w-full min-w-[280px] bg-white dark:bg-custom-dark-bg border border-1 text-black dark:text-white border-neutral-600 rounded-lg shadow-lg overflow-hidden">
 ...
 - [https://github.com/scottgal/](https://github.com/scottgal/) [https://hachyderm.io/@scottgal@hachyderm.io](https://hachyderm.io/@scottgal@hachyderm.io) [https://www.linkedin.com/in/scott-galloway-91608691/](https://www.linkedin.com/in/scott-galloway-91608691/)


 - [/rss](https://www.mostlylucid.net/rss)


 - [NuGet](https://www.nuget.org/profiles/mostlylucid)


 - [Software](https://www.mostlylucid.net/software)


 - [Contact](https://www.mostlylucid.net/contact)
...
## Cooking with DiSE (Part 4): Building Systems That Learn, Adapt, and Evolve
 ...
 ![English](mostlylucid_net-dise-architecture-overview-images/en_svg)





 ![हिन्दी (Hindi)](mostlylucid_net-dise-architecture-overview-images/hi_svg)





 ![Suomi (Finnish)](mostlylucid_net-dise-architecture-overview-images/fi_svg)





 ![Français (French)](mostlylucid_net-dise-architecture-overview-images/fr_svg)





 ![Nederlands (Dutch)](mostlylucid_net-dise-architecture-overview-images/nl_svg)





 ![Svenska (Swedish)](mostlylucid_net-dise-architecture-overview-images/sv_svg)





 ![Deutsch (German)](mostlylucid_net-dise-architecture-overview-images/de_svg)





 ![Español (Spanish)](mostlylucid_net-dise-architecture-overview-images/es_svg)





 ![Українська (Ukrainian)](mostlylucid_net-dise-architecture-overview-images/uk_svg)





 ![Italiano (Italian)](mostlylucid_net-dise-architecture-overview-images/it_svg)





 ![中文 (Chinese Simplified)](mostlylucid_net-dise-architecture-overview-images/zh_svg)





 ![العربية (Arabic)](mostlylucid_net-dise-architecture-overview-images/ar_svg)





 ![ελληνικά (Greek)](mostlylucid_net-dise-architecture-overview-images/el_svg)





 ![Português (Portuguese)](mostlylucid_net-dise-architecture-overview-images/pt_svg)





 ![Polski (Polish)](mostlylucid_net-dise-architecture-overview-images/pl_svg)
 ...
 [Comments](https://www.mostlylucid.net/blog/dise-architecture-overview#commentsection)

 [Raw](https://www.mostlylucid.net/api/raw/dise-architecture-overview?language=en)

 [Edit](https://www.mostlylucid.net/editor/edit?slug=dise-architecture-overview&language=en)
 ...
 [Newer: Learning LRUs - When Exceeding Capacity Makes Your System Better](https://www.mostlylucid.net/blog/learning-lrus-when-capacity-makes-systems-better)



 [Older: StyloBot: Fighting Back Against Scrapers (Part 1)](https://www.mostlylucid.net/blog/botdetection-introduction)
...
- [The Problem: Static Systems in a Dynamic World](https://www.mostlylucid.net/blog/dise-architecture-overview#the-problem-static-systems-in-a-dynamic-world)

- [The Core Idea: Systems as Evolving Organisms](https://www.mostlylucid.net/blog/dise-architecture-overview#the-core-idea-systems-as-evolving-organisms)

- [A Concrete Example: Bot Detection](https://www.mostlylucid.net/blog/dise-architecture-overview#a-concrete-example-bot-detection) [Perception: The Blackboard Architecture](https://www.mostlylucid.net/blog/dise-architecture-overview#perception-the-blackboard-architecture)

- [Evaluation: Weighted Consensus with Sigmoid](https://www.mostlylucid.net/blog/dise-architecture-overview#evaluation-weighted-consensus-with-sigmoid)

- [Early Exit: Fast Path Optimization](https://www.mostlylucid.net/blog/dise-architecture-overview#early-exit-fast-path-optimization)

- [Circuit Breakers: Self-Healing](https://www.mostlylucid.net/blog/dise-architecture-overview#circuit-breakers-self-healing)

- [Mutation: The Learning System](https://www.mostlylucid.net/blog/dise-architecture-overview#mutation-the-learning-system)

- [The Cognitive Stack](https://www.mostlylucid.net/blog/dise-architecture-overview#the-cognitive-stack)

- [The Heuristic Detector: Learning Without External Models](https://www.mostlylucid.net/blog/dise-architecture-overview#the-heuristic-detector-learning-without-external-models)

- [The Weight Store: Persistent Learning](https://www.mostlylucid.net/blog/dise-architecture-overview#the-weight-store-persistent-learning)

- [Hallucination as Mutation](https://www.mostlylucid.net/blog/dise-architecture-overview#hallucination-as-mutation)

- [The Genome: Policy-Based Configuration](https://www.mostlylucid.net/blog/dise-architecture-overview#the-genome-policy-based-configuration)

- [Fitness Functions: What Survives](https://www.mostlylucid.net/blog/dise-architecture-overview#fitness-functions-what-survives)

- [AI as Teacher, Not Worker](https://www.mostlylucid.net/blog/dise-architecture-overview#ai-as-teacher-not-worker)

- [Behavioural Routing: A New Category](https://www.mostlylucid.net/blog/dise-architecture-overview#behavioural-routing-a-new-category)

- [Why This Matters](https://www.mostlylucid.net/blog/dise-architecture-overview#why-this-matters)

- [What DiSE Isn't](https://www.mostlylucid.net/blog/dise-architecture-overview#what-dise-isnt)

- [Try It](https://www.mostlylucid.net/blog/dise-architecture-overview#try-it)

- [Conclusion](https://www.mostlylucid.net/blog/dise-architecture-overview#conclusion)
...
Perceive
Gather signals from the environment
Sensory organs
...
Mutate
Generate variants of strategies
Genetic mutation
...
public sealed record DetectionContribution
{
 ...
 public ImmutableDictionary Signals { get; init; }
}
```
...
while (waveNumber !ranDetectors.Contains(d.Name))
...
50-500ms
Deep reasoning
Analysing novel patterns

Learning
Background
Memory formation
Weight updates, reputation changes
...
public class HeuristicDetector : IDetector
{
 ...
 private static readonly Dictionary DefaultWeights = new()
 {
 ...
 private (bool IsBot, double Probability) RunInference(Dictionary features)
 {
...
{
 public static Dictionary ExtractFeatures(
 HttpContext context,
...
```
public async Task- > GenerateMutationsAsync(DetectionContext context) { var prompt = $""" Given this traffic pattern: {JsonSerializer.Serialize(context)} Generate 5 variant detection rules that might catch similar patterns. Return JSON array of rules with: pattern, weight, confidence. Be creative. Some variants should be strict, some lenient. """; var response = await _ollama.GenerateAsync(new GenerateRequest { Model = "gemma3:1b", Prompt = prompt, Options = new RequestOptions { Temperature = 0.9 } // High creativity }); return ParseRules(response.Response); } ``` The mutations are then evaluated against historical data: ``` public async Task SelectFittestAsync( List mutations, List testData) { var results = new List(); foreach (var rule in mutations) { var tp = testData.Count(r => rule.Matches(r) && r.IsBot); var fp = testData.Count(r => rule.Matches(r) && !r.IsBot); var fn = testData.Count(r => !rule.Matches(r) && r.IsBot); // F1 score as fitness var precision = tp / (double)(tp + fp); var recall = tp / (double)(tp + fn); var f1 = 2 * (precision * recall) / (precision + recall); results.Add((rule, f1)); } return results.OrderByDescending(r => r.Fitness).First().Rule; } ``` Only the fittest survive to production. This transforms LLMs from brittle chatbots into evolutionary operators. ## The Genome: Policy-Based Configuration At the centre of DiSE is the policy system - named configurations that define how detection behaves: ``` { "Policies": { "fastpath": { "Description": "Fast path + Heuristic for sync decisions", "FastPath": ["UserAgent", "Header", "Ip", "Behavioral", "ClientSide", "Inconsistency", "VersionAge"], "AiPath": ["Heuristic"], "EscalateToAi": true, "EarlyExitThreshold": 0.15, "ImmediateBlockThreshold": 0.90, "Weights": { "ClientSide": 0.2, "Heuristic": 1.5 }, "Transitions": [ { "WhenRiskExceeds": 0.5, "WhenRiskBelow": 0.85, "GoTo": "demo" } ] }, "demo": { "Description": "Full pipeline sync for demonstration", "FastPath": [], "AiPath": [], "BypassTriggerConditions": true, "ForceSlowPath": true } } } ``` Policies define: FastPath detectors - run in parallel, sub-10ms
...
" class="pt-6 print:!hidden" id="commentsection">
 ...
 [![logo](mostlylucid_net-dise-architecture-overview-images/logo_svg)](https://www.mostlylucid.net/)
 ...
 [https://github.com/scottgal/](https://github.com/scottgal/)

 [https://hachyderm.io/@scottgal@hachyderm.io](https://hachyderm.io/@scottgal@hachyderm.io)

 [https://www.linkedin.com/in/scott-galloway-91608691/](https://www.linkedin.com/in/scott-galloway-91608691/)
